...
int main()
{
    ...
    Team t[2], t0;
    cout << "Enter the First Team name: ";
    t[0].setTeamname();
    cout << "Enter the Second Team name: ";
    t[1].setTeamname();
    ...
    if (d == 1)
        cout << "Enter " << player_number << " player name for batting team:" << t[toss_won].teamName << nl;
    else
        cout << "Enter " << player_number << " player name for bowling team:" << t[toss_won].teamName << nl;
    ...
    if (d == 0)
        cout << "Enter " << player_number << " player name for batting team:" << t[toss_lost].teamName << nl;
    else
        cout << "Enter " << player_number << " player name for bowling team:" << t[toss_lost].teamName << nl;
    for (ll i = 0; i < player_number; i++)
    {
        if (i == 0)
            cout << "1st player name: ";
    ...
    if (d == 1)
        cout << "Enter " << 6 * over << " bowl Run for team: " << t[toss_won].teamName << nl;
    else
        cout << "Enter " << 6 * over << " bowl Run for team: " << t[toss_lost].teamName << nl;
    ...
    cout << "\n......AFTER TWO INNINGS........\n";
    if (d == 1)
        cout << "Team " << t[toss_won].teamName << " Result." << nl;
    else
        cout << "Team " << t[toss_lost].teamName << " Result." << nl;
    ...
    if (total_run > Total_Run)
    {
        ...
        if (d == 1)
            cout << "Congratulations!!! Team " << t[toss_won].teamName << " for WON the game by " << dif << " Run." << nl;
        else
            cout << "Congratulations!!! Team " << t[toss_lost].teamName << " for WON the game by " << dif << " Run." << nl;
    }
